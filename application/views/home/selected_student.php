...
getname_success=function(data){
    ...
    cancelconfirm_success = function(data) {
        if (data.status == "failed") {
            alert(data.reason);
        }
        else {
            alert("取消确认成功！");
            url="http://localhost:8080/index.php?c=Browse&a=jumptoselected";
            window.location.href=url;
        }
    }
    function cancelConfirm(no) {
        var str="course"+no;
        ...
        if(course.innerHTML=="空"){
            ...
            var url = "http://localhost:8080/index.php?c=Browse&a=DisConfirm";
            var json = "{\"studentid\":"+studentid+",\"courseid\":"+course_number+"}";
            json = JSON.parse(json);
            ajax_send(url, json, cancelconfirm_success, load_error);
        }
    }
</script>
<script type="text/javascript">
...
getstudents_success=function(data){
    ...
    function get_students(){
        ...
        json=JSON.parse(json);
        var url="http://localhost:8080/index.php?c=Browse&a=getConfirmedStudent";
                    ...
                    <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right margin-top cl-effect-2">
                                ...
                                <li><a href="http://localhost:8080/index.php?c=SC&a=jump"><span data-hover="choose_course">查看学生</span></a></li>
                                <li><a href="http://localhost:8080/application/views/home/typography.php"><span data-hover="course">已选学生</span></a></li>
                ...
                <li>
                    <figure>
                        ...
                        <center><h3 id="course1">空</h3></center>
                            ...
                            <input type="button" id="choose1" style="width: auto; background:#232428;color: #fff;font-size: 0.8725em;padding: 7px 20px;border: none;margin: 0 12px 0 0;cursor: pointer;transition: all .5s;-webkit-transition: all .5s;-moz-transition: all .5s;-o-transition: all .5s;outline:none;text-transform: uppercase;position:absolute;left:250px;top:225px;" value="取消确认" onclick="cancelConfirm(1)">
                        </figcaption>
                    </figure>
                </li>
                <li>
