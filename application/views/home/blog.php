                    ...
                    <nav class="navbar tm-main-nav">
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item">
                                    <a href="http://localhost:8080/application/views/home/index.html" class="nav-link">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://localhost:8080/application/views/home/about.html" class="nav-link">About</a>
                                </li>
                                <li class="nav-item active">
                                    <a href="http://localhost:8080/application/views/home/blog.html" class="nav-link">Blog</a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://localhost:8080/application/views/home/contact.html" class="nav-link">Contact</a>
                                </li>
                            </ul>
                        </div>
